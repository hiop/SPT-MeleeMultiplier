...
)
{
    ...
    public List<string>? GetExcludedMeleeItems()
    {
        return _config!.ExcludedMeleeItems;
    }
}
...
public class MeleeMultiplierConfig
{
    ...
    [JsonPropertyName("excludedMeleeItems")]
    public List<string>? ExcludedMeleeItems { get; set; }
}